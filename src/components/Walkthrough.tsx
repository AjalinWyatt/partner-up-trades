...
const STEPS: Step[] = [
  ...
  { target: "nav-feed", title: "Community", body: "Pulse — connect with traders in real time.", route: "/feed" },
  ...
  { target: "nav-log", title: "Journal", body: "Log every trade. Builds your streak and helps your partner keep you accountable.", route: "/trading-log" },
