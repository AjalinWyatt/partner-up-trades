...
const detailGroups = (profile: DataRecord, tradingProfile: DataRecord): [string, string[]][] => [
  ...
  ["Strengths & support", asList(tradingProfile?.struggles)],
  ["Looking for", unique([...asList(tradingProfile?.connection_types), ...asList(tradingProfile?.looking_for_gender), ...asList(tradingProfile?.connection_reach)])],
