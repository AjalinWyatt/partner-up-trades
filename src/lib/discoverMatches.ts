...
const profileFields = "id, username, full_name, avatar_url, gender, location, city, state, country, hobbies, birth_year, created_at, last_seen_at, hidden_from_discover";
