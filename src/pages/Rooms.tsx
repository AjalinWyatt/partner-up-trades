        ...
        <div className="mb-3 flex items-center justify-between">
          <div>
            <h1 className="flex items-center gap-2 text-xl font-bold text-foreground">
              <Radio className="h-5 w-5 text-primary" /> Voice Rooms
            </h1>
            <p className="text-xs text-muted-foreground">Async co-working — drop voice notes + chat while you trade.</p>
          </div>
          <button
            ...
            {rooms.map((r) => (
              ...
              >
                <div className="mb-1 flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  {r.market && <span className="rounded-full bg-secondary px-2 py-0.5 text-[10px] font-semibold uppercase">{r.market}</span>}
