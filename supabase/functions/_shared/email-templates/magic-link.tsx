...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your TradersWorld sign-in link</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          <Text style={brand}>TradersWorld</Text>
          <Heading style={h1}>Your sign-in link</Heading>
          <Text style={lede}>Tap the button below to sign in. The link works once and expires shortly.</Text>
          <table cellPadding={0} cellSpacing={0} role="presentation" style={btnWrap}><tbody><tr><td align="center" style={btnCell}>
            <Link href={confirmationUrl} style={button}>Sign in to TradersWorld</Link>
          </td></tr></tbody></table>
          ...
          <Text style={footer}>If you didn't request this, ignore this email — your account is safe.</Text>
        </Section>
